...
| D | `codex/orca-ehr-r2-worker-d-live-orca` | R2-D01 live ORCA Trial execution, adapter contract, retry/idempotency evidence | Active | 20260511T111751Z | this commit | live Trial blocked until same-RUN_ID runtime/candidate/exact preflight/manual approval prerequisites are available |
