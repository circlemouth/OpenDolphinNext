...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 20260511T101116Z | C | R2-C19 | 8/9/10.2/14 prescription history allowlist snapshot; disease mutation request field completeness | this commit | focused Maven candidate/disease DTO tests passed; targeted Vitest passed; `typecheck`, web guard, doc/config/runtime guards, `git diff --check` passed | Done | Coordinate with B export integration and D live send/re-fetch without implementing live transport |
