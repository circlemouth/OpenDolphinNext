...
|---|---|---|---|---|---|
| Electronic chart order entry and prescription input fully verified? | Clinical Wave 1 local/server/component/static verification exists for selected chart/order/prescription workflows. Artifact-free browser local persistence evidence and one SOAP/disease UI clickthrough now exist for selected RWO-02 through RWO-05 workflows. | Fully verified end-to-end; release-ready; full prescription/order UI click-through/fullflow/live ORCA verified. | WO-3 CWP-01; WO-4 CWP-03/04; WO-3/4 final reports; RUN_ID `20260423T010054Z`, `20260423T023456Z`, `20260423T030122Z`, and `20260423T050222Z` safe browser evidence. | Prescription/order full UI click-through browser coverage, fullflow, live Trial medicalmodv2. Production ORCA is out of scope. | RWO-02-RWO-06. |
...
| Trial-backed release readiness? | Repo-local roadmap, local/static evidence, partial artifact-free browser evidence, RWO-09 non-S3 static/CI evidence, owner standing approval, and the RWO-06A non-S3 runtime profile direction are consolidated. | Production-ready, production ORCA ready, S3/object-storage ready, final Trial-backed release GO, or production release-ready. | Current roadmap scope and manager/release docs; RUN_ID `20260423T030122Z` RWO-09 static/CI evidence; RUN_ID `20260423T034854Z` RWO-10/RWO-11 non-claim marker; RUN_ID `20260423T035517Z` owner standing approval marker; RUN_ID `20260423T054833Z` non-S3 runtime profile direction. | Implemented Trial-scope non-S3 runtime profile, final owner GO/NO-GO, full UI browser/fullflow evidence, and live Trial expansion through an approved non-S3 path. Production ORCA is `not_applicable_trial_only`; S3/object-storage is `not_applicable_out_of_scope`. | RWO-06A then RWO-09-RWO-11. |
