...
3. `指導料`, base-charge acceptance, injection acceptance, surgery acceptance, test-order acceptance, radiology acceptance, SOAP, and disease CRUD Trial reachability remains missing. RUN_ID `20260424T031608Z` accepted endpoint-specific prescription and representative treatment/generic `medicalmodv2` L3 Trial evidence, but it is not fullflow or broad order matrix coverage. RUN_ID `20260424T044007Z` now lists documents/fees/order classes explicitly, RUN_ID `20260424T044803Z` shows `指導料` class `130` v1 is safely tested but Trial-rejected, RUN_ID `20260424T050223Z` blocks `指導料` v2 pending a business/Trial data decision and records `baseChargeOrder/110` v1 as live `businessRejected`, RUN_ID `20260424T052654Z` records `injectionOrder/310` v1 as live `businessRejected`, RUN_ID `20260424T055036Z` records `surgeryOrder/500` v1 as live `businessRejected`, RUN_ID `20260424T055036Z` records `testOrder/600` v1 as live `businessRejected`, RUN_ID `20260424T061549Z` records `radiologyOrder/700` v1 as live `businessRejected`, RUN_ID `20260424T063936Z` adds no-live `subjectivesv2`/`diseasev3` wrapper contracts, and RUN_ID `20260424T070217Z` adds fixed server official-wrapper scaffolding while keeping live SOAP/disease execution blocked.
