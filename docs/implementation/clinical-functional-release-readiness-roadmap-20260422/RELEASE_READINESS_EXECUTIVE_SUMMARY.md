...
3. Individual prescription, treatment/generic order, SOAP, and disease CRUD Trial reachability remains missing. RUN_ID `20260424T025733Z` adds RWO-06B/RWO-06C/RWO-06D/RWO-08B to verify unconfirmed reachability in hourly resumable batches, but no new reachability execution has happened under that plan yet.
