...
3. `指導料`, base-charge acceptance, injection acceptance, surgery acceptance, test-order acceptance, radiology acceptance, SOAP, and disease CRUD Trial reachability remains missing. RUN_ID `20260424T031608Z` accepted endpoint-specific prescription and representative treatment/generic `medicalmodv2` L3 Trial evidence, but it is not fullflow or broad order matrix coverage. RUN_ID `20260424T044007Z` now lists documents/fees/order classes explicitly, RUN_ID `20260424T044803Z` shows `指導料` class `130` v1 is safely tested but Trial-rejected, RUN_ID `20260424T050223Z` blocks `指導料` v2 pending a business/Trial data decision and records `baseChargeOrder/110` v1 as live `businessRejected`, RUN_ID `20260424T052654Z` records `injectionOrder/310` v1 as live `businessRejected`, RUN_ID `20260424T055036Z` records `surgeryOrder/500` v1 as live `businessRejected`, RUN_ID `20260424T055036Z` records `testOrder/600` v1 as live `businessRejected`, RUN_ID `20260424T061549Z` records `radiologyOrder/700` v1 as live `businessRejected`, RUN_ID `20260424T063936Z` adds no-live `subjectivesv2`/`diseasev3` wrapper contracts, RUN_ID `20260424T070217Z` adds fixed server official-wrapper scaffolding, RUN_ID `20260424T080121Z` adds the no-live `subjectivesv2` live-readiness identity, RUN_ID `20260424T090051Z` adds the no-live create-only `diseasev3` live-readiness identity, and RUN_ID `20260424T100223Z` records one sanitized `subjectivesv2` live wrapper action as `transportRejected` HTTP 404, not business accepted.
...
- RUN_ID `20260424T061549Z`: RWO-06K added endpoint-specific `radiologyOrder/700` wrapper/payload evidence plus one sanitized Trial attempt; live result was `businessRejected`, not accepted.
- RUN_ID `20260424T063936Z`: RWO-06B-next added no-live `subjectivesv2` and `diseasev3` safe wrapper/parser contracts plus dry-runs; both stub parsers classify as `notVerified`, so no SOAP/disease Trial success is claimed.
- RUN_ID `20260424T070217Z`: RWO-06B-next added fixed server official-wrapper scaffolding for `subjectivesv2` and `diseasev3`, focused tests, and route inventory updates; live Trial mutation was not run and stub responses remain `notVerified`.
- RUN_ID `20260424T080121Z`: RWO-06B-next prepared the no-live `subjectivesv2` live-readiness identity and exact duplicate-live checkpoint; no live mutation was run.
- RUN_ID `20260424T090051Z`: RWO-06B-next prepared the no-live create-only `diseasev3` live-readiness identity and exact duplicate-live checkpoint; no live mutation was run and update/delete remains unauthorized.
- RUN_ID `20260424T100223Z`: RWO-06D-soap-next added live-mode support to the safe SOAP/disease wrapper, reran subjectivesv2 no-live preflight/tests, then executed one exact sanitized `subjectivesv2` live wrapper action. Backend health/readiness were `200/200`, but the official route returned HTTP `404`; classification is `transportRejected`, not business success. The next handoff requires current-runtime route/deployment verification before any retry.
