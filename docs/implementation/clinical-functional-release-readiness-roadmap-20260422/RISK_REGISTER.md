...
| S3/object-storage readiness accidentally treated as required or claimed. | High | Roadmap now skips S3/MinIO/object-storage-dependent tasks. | Attachment storage or PHR export storage would need a separate owner-approved S3 plan later. | RWO-09/RWO-11 record `not_applicable_out_of_scope`. |
