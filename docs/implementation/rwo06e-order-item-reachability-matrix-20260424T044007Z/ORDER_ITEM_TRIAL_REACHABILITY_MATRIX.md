...
| `injectionOrder` | 注射 | `310`, `311`, `312`, `320`, `321`, `330`, `331`, `334`, `340`, `350` | sendable | `no_live_verified` | Define injection representative payload identities by class family, no-live wrapper tests, sanitizer/parser tests, and duplicate-live checkpoints before Trial execution. |
