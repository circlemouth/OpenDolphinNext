...
|---|---|---|
| `web-client/qa/payloads/phase4/medicalmodv2_phase4_dummy_current_wrapper_v1.json` | Current active medicalmodv2 wrapper candidate. Includes current route-required `encounterContext.insuranceCombinationNumber`, `voucherNumber`, and `sequentialNumber`. | `e0f34fa28177155bf19cc0476863bf540f8b1ff4d844ddf189b88ab327645618` |
...
The current-wrapper candidate has a new JSON sha256 and includes `insuranceCombinationNumber=0001`.
...
- `medicalmodv2_phase4_dummy_current_wrapper_v1.json`: PASS through current `qa-phase4-safe-medicalmodv2.mjs` dry-run gate with `--payload-sha256 e0f34fa28177155bf19cc0476863bf540f8b1ff4d844ddf189b88ab327645618`; live Trial action `not_run`.
