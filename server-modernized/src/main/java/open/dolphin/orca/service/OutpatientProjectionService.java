...
@ApplicationScoped
public class OutpatientProjectionService {
    ...
    public List<MedicalOutpatientResponse.MedicalOutpatientEntry> loadEntries(String facilityId, Map<String, Object> payload) {
    ...
    private List<PatientVisitModel> fetchVisits(String facilityId, LocalDate targetDate) {
        ...
        return pvtServiceBean.getPvt(facilityId, targetDate.toString(), 0, PVTServiceBean.DEFAULT_PVT_PAGE_SIZE, null, null);
    }
    ...
    private MedicalOutpatientResponse.MedicalOutpatientEntry buildMedicalEntry(String facilityId, PatientVisitModel visit,
        ...
        Map<String, MedicalOutpatientResponse.MedicalSection> sections = new java.util.LinkedHashMap<>();
