...
## Repo Source Snapshot Included

This rebuilt package includes a curated tracked source snapshot:

- `repo-source-snapshot-open-dolphin-next-ba180009b.zip`
- `repo-source-snapshot-open-dolphin-next-ba180009b.zip.sha256`

It is generated from git HEAD `ba180009b` and includes current docs, web-client, server-modernized modules, tests, ops/scripts, and build/config files. It intentionally excludes ignored runtime artifacts and legacy `client/` / `server/` directories.

For ChatGPT, pass the outer zip `orca-spec-research-package-20260426T121533Z.zip`. The inner repo-source snapshot is included for optional source lookup.
