...
description: Create the reviewer package zip for OpenDolphin_WebClient using tracked source/config/docs plus browser manual QA summary files when present, excluding legacy client sources and generated outputs.
---
...
- tracked repo files, with legacy and generated paths excluded
...
The packaging script also appends these QA summary files when they exist:
