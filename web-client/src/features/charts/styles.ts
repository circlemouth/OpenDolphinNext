...
export const chartsStyles = css`
  ...
  .charts-workbench {
    ...
    flex-direction: column;
    gap: var(--charts-space-md);
    --charts-column-left: minmax(184px, 0.46fr);
    ...
    --charts-utility-footer-width: 0px;
    --charts-utility-drawer-width: min(var(--charts-utility-expanded-width), calc(100vw - 128px));
    --charts-utility-footer-height: 0px;
    --charts-utility-drawer-height: min(var(--charts-utility-expanded-height), 70vh);
    position: relative;
    isolation: isolate;
  ...
  .charts-page[data-charts-ui-opt-b='1'] .charts-workbench {
    ...
    --charts-column-left: minmax(176px, 0.44fr);
  ...
  .charts-page[data-charts-ui-opt-b='1'] .charts-workbench[data-charts-compact-ui='1'] {
    --charts-column-left: minmax(164px, 0.4fr);
  ...
  .chart-safety-banner__item[data-tone='warning'] {
    border-color: rgba(217, 119, 6, 0.36);
    background: rgba(255, 251, 235, 0.95);
  }

  .chart-safety-banner__item[data-tone='danger'] {
    border-color: rgba(185, 28, 28, 0.34);
    background: rgba(254, 242, 242, 0.95);
  }

  .chart-safety-banner__item[data-tone='success'] {
    border-color: rgba(22, 101, 52, 0.28);
    background: rgba(240, 253, 244, 0.9);
  }

  .chart-safety-banner__body p {
    margin: 0;
    line-height: 1.45;
    color: #334155;
    font-weight: 700;
  ...
  .clinical-panel-shell,
  .clinical-drawer-shell,
  .diff-preview-layout,
  .orca-result-panel {
    border: 1px solid rgba(148, 163, 184, 0.28);
    border-radius: var(--charts-radius-md);
  ...
  .clinical-panel-shell__header,
  .clinical-drawer-shell__header,
  .diff-preview-layout__header,
  .orca-result-panel__header {
    display: flex;
    justify-content: space-between;
    gap: var(--charts-space-sm);
    padding: var(--charts-space-sm);
  ...
  .clinical-panel-shell__header h2,
  .clinical-drawer-shell__header h2,
  .diff-preview-layout__header h3,
  .orca-result-panel__header h3 {
    margin: 0;
    color: #0f172a;
    font-size: 1rem;
  }

  .clinical-panel-shell__eyebrow,
  .clinical-drawer-shell__eyebrow,
  .orca-result-panel__eyebrow {
    margin: 0 0 0.18rem;
    color: #64748b;
    font-size: 0.74rem;
    font-weight: 800;
  ...
  .clinical-panel-shell__content,
  .clinical-drawer-shell__grid,
  .diff-preview-layout__grid {
    padding: var(--charts-space-sm);
  }

  .clinical-drawer-shell__search,
  .clinical-drawer-shell__footer {
    padding: var(--charts-space-sm);
  ...
  .diff-preview-layout__pane--after {
    background: rgba(239, 246, 255, 0.9);
  }

  .diff-preview-layout__pane h4 {
    margin: 0 0 var(--charts-space-xs);
    color: #334155;
  }

  .orca-result-panel {
    margin: var(--charts-space-sm) 0;
    padding-bottom: var(--charts-space-sm);
  }

  .orca-result-panel[data-state='unknown'],
  .orca-result-panel[data-state='warning'] {
    border-color: rgba(217, 119, 6, 0.4);
    background: rgba(255, 251, 235, 0.9);
  }

  .orca-result-panel[data-state='error'] {
    border-color: rgba(185, 28, 28, 0.38);
    background: rgba(254, 242, 242, 0.92);
  }

  .orca-result-panel[data-state='success'] {
    border-color: rgba(22, 101, 52, 0.28);
    background: rgba(240, 253, 244, 0.86);
  }

  .orca-result-panel__message,
  .orca-result-panel__next,
  .orca-result-panel__evidence {
    margin: var(--charts-space-sm) var(--charts-space-sm) 0;
    color: #334155;
    line-height: 1.5;
  }

  .orca-result-panel__facts {
    display: grid;
  ...
  .orca-result-panel__facts div {
    padding: var(--charts-space-xs);
    border-radius: var(--charts-radius-sm);
    background: rgba(255, 255, 255, 0.74);
  }

  .orca-result-panel__facts dt {
    color: #64748b;
    font-size: 0.75rem;
    font-weight: 800;
  }

  .orca-result-panel__facts dd {
    margin: 0.15rem 0 0;
    color: #0f172a;
    font-weight: 800;
  }

  .orca-result-panel__evidence ul {
    margin: 0;
  ...
  .charts-patient-summary__inline-actionbar .charts-actions__patient-inline {
    display: grid;
    grid-template-columns: var(--charts-patient-action-left) minmax(0, 1fr) var(--charts-patient-action-right);
    align-items: center;
    height: 100%;
    pointer-events: none;
  }

  .charts-actions__patient-action-slot {
    display: flex;
    align-items: center;
    pointer-events: auto;
  }

  .charts-actions__patient-action-slot--left {
    justify-content: center;
  }

  .charts-actions__patient-action-slot--stack {
    flex-direction: column;
    align-items: stretch;
    justify-content: center;
    gap: 0.3rem;
  ...
  .charts-actions__patient-inline-spacer {
    display: block;
    min-width: 1px;
  }
  ...
  @media (max-width: 720px) {
    ...
    .charts-patient-summary__inline-actionbar {
      position: static;
      padding: 0 0 var(--charts-space-xs);
      order: -1;
    }
  ...
  .charts-workbench__body {
    display: grid;
    grid-template-columns: minmax(220px, var(--charts-column-left)) minmax(0, 1fr) minmax(320px, min(34vw, 520px));
  ...
  .charts-workbench__column--center {
    grid-column: 2 / 4;
  }
  ...
  .charts-page > .charts-focus-anchor:first-child {
    position: absolute;
  }
  ...
  .charts-docked-panel__drawer {
    position: fixed;
    left: var(--charts-utility-left);
    right: auto;
    top: var(--charts-utility-top);
    width: min(var(--charts-utility-drawer-width), calc(100vw - var(--charts-utility-left) - 96px));
    max-width: calc(100vw - var(--charts-utility-left) - 96px);
    bottom: auto;
    border-radius: var(--charts-radius-md);
    border: 1px solid var(--ui-border);
    ...
    flex-direction: column;
    gap: var(--charts-space-sm);
    height: min(var(--charts-utility-drawer-height), calc(100vh - var(--charts-utility-top) - 16px));
    max-height: calc(100vh - var(--charts-utility-top) - 16px);
    overflow: hidden;
  ...
  .charts-docked-panel__resize-handle {
    position: fixed;
    left: calc(var(--charts-utility-left) + min(var(--charts-utility-drawer-width), calc(100vw - var(--charts-utility-left) - 96px)) - 26px);
    top: calc(var(--charts-utility-top) + min(var(--charts-utility-drawer-height), calc(100vh - var(--charts-utility-top) - 16px)) - 26px);
    width: 22px;
    height: 22px;
    border: 1px solid var(--ui-border-strong);
    border-radius: 6px;
  ...
  .charts-side-panel__workspace[data-order-editor-layout='manual-first'] {
    grid-template-columns: minmax(0, 1fr);
    align-items: start;
  }

  .charts-side-panel__workspace[data-order-editor-layout='manual-first'] .charts-side-panel__workspace-right {
    order: 1;
    grid-column: 1 / -1;
    padding-right: 0;
  }

  .charts-side-panel__workspace[data-order-editor-layout='manual-first'] .charts-side-panel__workspace-left {
    order: 2;
    grid-column: 1 / -1;
    padding-right: 0;
  }

  .charts-order-editor__manual-primary {
    display: flex;
    flex-direction: column;
    gap: var(--charts-space-sm);
  }
  ...
  .charts-side-panel__section[data-order-layout='compact-kirin'] {
    --charts-order-dense-gap: 0.34rem;
    font-size: 0.8125rem;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__section-header {
    align-items: center;
    padding: 0.46rem 0.56rem;
    border-radius: var(--charts-radius-sm);
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__section-header strong {
    font-size: 0.88rem;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__dock-body,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-order-editor__manual-primary,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__workspace-right,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__workspace-left {
    gap: var(--charts-order-dense-gap);
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__form {
    gap: var(--charts-order-dense-gap);
    padding: 0.48rem;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-order-editor__manual-card,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-order-editor__secondary-section {
    padding: 0.48rem;
    border-radius: var(--charts-radius-sm);
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__field-row {
    gap: var(--charts-order-dense-gap);
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__field {
    gap: 2px;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__subheader {
    flex-wrap: wrap;
    gap: 0.28rem;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__subheader-actions {
    flex: 1 1 12rem;
    min-width: 0;
    max-width: 100%;
    justify-content: flex-end;
  ...
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__subheader-actions > button {
    flex: 1 1 5.8rem;
    min-width: 0;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__field label {
    font-size: 0.72rem;
    line-height: 1.2;
    font-weight: 800;
  }

  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__form input,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__form textarea,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__form select {
    min-height: 30px;
  ...
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__ghost,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__row-delete,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__action,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__chip-button,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__switch-button {
    min-height: 30px;
  ...
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__help,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__message,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__field-error {
    font-size: 0.72rem;
    line-height: 1.3;
  }

  .charts-order-editor__rx-compact-band {
  ...
  .charts-order-editor__base-charge-segment {
    gap: 0.26rem;
  }

  .charts-order-editor__kirin-grid {
    display: grid;
    gap: var(--charts-space-xs);
  }
  ...
  .charts-order-editor__kirin-grid-header span {
    font-size: 0.74rem;
    color: #475569;
  }

  .charts-order-editor__kirin-table {
    display: grid;
    gap: 1px;
    overflow-x: auto;
  ...
  .charts-order-editor__kirin-table-row {
    display: grid;
  ...
  .charts-order-editor__kirin-grid--injection .charts-order-editor__kirin-table-row {
    grid-template-columns: minmax(10rem, 1.5fr) minmax(6rem, 0.8fr) minmax(5rem, 0.7fr) minmax(5rem, 0.7fr) minmax(8rem, 1fr) minmax(7rem, 0.9fr) minmax(6rem, 0.8fr) minmax(6rem, 0.8fr);
    min-width: 52rem;
  }

  .charts-order-editor__kirin-table-row--header {
    background: #f8fafc;
    font-weight: 800;
    color: #334155;
  }
  ...
  .charts-order-editor__kirin-table-row > span:last-child {
    border-right: 0;
  }

  .charts-order-editor__kirin-table-row [data-unresolved='true'] {
    color: #92400e;
    background: #fff7ed;
    font-weight: 800;
  }
  ...
  .charts-order-editor__kirin-injection-controls {
    align-items: end;
    grid-template-columns: minmax(7rem, 0.7fr) minmax(8rem, 0.9fr);
    max-width: 24rem;
  }

  .charts-order-editor__unit-input {
    display: grid;
    grid-template-columns: minmax(0, 1fr) auto;
    align-items: center;
    gap: var(--charts-space-2xs);
  ...
  .charts-order-editor__unit-input span {
    font-size: 0.78rem;
    color: #475569;
    font-weight: 800;
  }

  .charts-order-editor__secondary {
    display: grid;
  ...
  .charts-order-editor__secondary-section {
    border: 1px solid rgba(148, 163, 184, 0.28);
  ...
  .charts-order-editor__secondary-summary {
    cursor: pointer;
    list-style-position: inside;
  }

  .charts-order-editor__manual-primary > .charts-order-editor__secondary-section {
    order: 30;
  }

  .charts-order-editor__sticky-footer {
    position: sticky;
    bottom: 0;
    z-index: 4;
    background: rgba(255, 255, 255, 0.96);
  ...
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__item-row {
    gap: 0.28rem;
    padding: 0.14rem;
  }

  .charts-side-panel__item-row--compact-order {
    grid-template-columns: 28px minmax(10rem, 1.7fr) minmax(4.4rem, 0.54fr) minmax(3.8rem, 0.48fr) 28px;
    min-width: 28rem;
  }

  .charts-side-panel__item-row--injection-main {
    grid-template-columns: 28px minmax(11rem, 1.8fr) minmax(4.7rem, 0.55fr) minmax(4rem, 0.48fr) 28px;
  }

  .charts-side-panel__item-row--charge-main,
  .charts-side-panel__item-row--test-main {
    grid-template-columns: 28px minmax(12rem, 1.9fr) minmax(4.8rem, 0.58fr) minmax(4.2rem, 0.48fr) 28px;
  }

  .charts-side-panel__item-row--rx-drug {
    grid-template-columns:
      minmax(8.4rem, 1fr)
      minmax(3.8rem, 0.32fr)
      minmax(3.4rem, 0.28fr);
    min-width: 0;
    align-items: start;
    overflow-x: visible;
  }

  .charts-side-panel__item-row--rx-drug > .charts-order-editor__rx-drug-switches,
  .charts-side-panel__item-row--rx-drug > .charts-order-editor__rx-drug-comment,
  .charts-side-panel__item-row--rx-drug > .charts-side-panel__template-actions,
  .charts-side-panel__item-row--rx-drug > .charts-side-panel__item-actions,
  .charts-side-panel__item-row--rx-drug > .charts-side-panel__help,
  .charts-side-panel__item-row--rx-drug > .charts-side-panel__message {
    grid-column: 1 / -1;
  }

  .charts-order-editor__rx-drug-switches {
    display: flex;
    flex-wrap: wrap;
    gap: 0.24rem;
  }

  .charts-order-editor__rx-drug-switches > .charts-side-panel__switch-button,
  .charts-order-editor__rx-drug-switches > .charts-side-panel__action {
    flex: 1 1 7rem;
    min-width: 6.6rem;
    white-space: normal;
  }
  ...
  .charts-side-panel__item-row--order-comment {
    grid-template-columns: minmax(9rem, 0.9fr) minmax(14rem, 1.8fr) minmax(4.8rem, 0.5fr) minmax(4rem, 0.44fr) auto;
  }

  .charts-side-panel__item-row--injection-comment {
    grid-template-columns: minmax(8rem, 1fr) minmax(12rem, 1.45fr);
  }

  .charts-side-panel__item-row--material-main {
    grid-template-columns: minmax(11rem, 1.6fr) minmax(4.8rem, 0.58fr) minmax(4.2rem, 0.48fr) 28px;
  }
  ...
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__drag-handle,
  .charts-side-panel__section[data-order-layout='compact-kirin'] .charts-side-panel__icon {
    width: 28px;
    height: 28px;
  }
  ...
  .charts-diagnosis-panel {
    --charts-order-accent-bg: rgba(37, 99, 235, 0.1);
    --charts-order-accent-border: rgba(37, 99, 235, 0.26);
    --charts-order-accent-text: #1e3a8a;
    --charts-order-soft-surface: #f8fafc;
  }

  .charts-diagnosis-panel .charts-side-panel__section-header {
    align-items: center;
    flex-wrap: wrap;
    gap: var(--charts-space-xs);
  ...
  .charts-diagnosis__title-block {
    display: grid;
    gap: var(--charts-space-2xs);
    min-width: 0;
  }

  .charts-diagnosis__title-row {
    display: flex;
    align-items: center;
    gap: var(--charts-space-xs);
    flex-wrap: wrap;
  ...
  .charts-diagnosis__organize-button {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    min-height: 44px;
  ...
  .charts-diagnosis__organize-button[aria-disabled='true']:not(:disabled) {
    border-color: rgba(245, 158, 11, 0.45);
    background: #fff7ed;
    color: #9a3412;
    cursor: pointer;
  ...
  .charts-diagnosis__table-wrap {
    max-height: clamp(112px, 20vh, 240px);
    overflow-y: auto;
    overflow-x: hidden;
    border: 1px solid var(--ui-border-subtle);
    border-radius: var(--charts-radius-sm);
  ...
  .charts-diagnosis__table th,
  .charts-diagnosis__table td {
    border-bottom: 1px solid var(--ui-border-subtle);
  ...
  .charts-diagnosis__table thead th {
    position: sticky;
    top: 0;
    z-index: 1;
    background: #f8fafc;
  ...
  .charts-diagnosis__table tbody tr:last-child th,
  .charts-diagnosis__table tbody tr:last-child td {
    border-bottom: 0;
  }

  .charts-diagnosis__row {
    background: #ffffff;
  }

  .charts-diagnosis__cell {
    font-variant-numeric: tabular-nums;
  }

  .charts-diagnosis__cell--name {
    width: 32%;
    min-width: 9rem;
    color: #0f172a;
  }

  .charts-diagnosis__cell--attrs {
    width: 4.4rem;
  }

  .charts-diagnosis__cell--date {
    width: 6.2rem;
    white-space: nowrap;
  }

  .charts-diagnosis__cell--outcome {
    width: 6.2rem;
  }

  .charts-diagnosis__cell--outcome > span:first-child {
    display: inline-flex;
    align-items: center;
    min-height: 1.35rem;
    border-radius: var(--charts-radius-sm);
  ...
  .charts-diagnosis__cell--actions {
    width: 6.8rem;
  }

  .charts-diagnosis__subvalue {
    display: block;
    margin-top: 1px;
    color: #64748b;
    font-size: 0.68rem;
  ...
  .charts-diagnosis__item-actions {
    align-items: center;
    justify-content: flex-end;
  }

  .charts-side-panel__item-actions.charts-diagnosis__item-actions .charts-diagnosis__action-button {
    display: inline-flex;
    align-items: center;
    justify-content: center;
    width: 2rem;
  ...
  .charts-side-panel__item-actions.charts-diagnosis__item-actions .charts-diagnosis__action-button--danger {
    border-color: rgba(239, 68, 68, 0.34);
    background: #fff1f2;
  }

  .charts-side-panel__item-actions.charts-diagnosis__item-actions .charts-diagnosis__action-button--send {
    border-color: rgba(13, 148, 136, 0.34);
    background: #f0fdfa;
  }

  .charts-side-panel__item-actions.charts-diagnosis__item-actions .charts-diagnosis__action-button:disabled {
  ...
  .charts-diagnosis__action-icon {
    width: 1.08rem;
    height: 1.08rem;
  }

  .charts-workbench__column--left .charts-diagnosis__table {
    display: block;
    font-size: 0.68rem;
  }

  .charts-workbench__column--left .charts-diagnosis__table thead {
    position: absolute;
    width: 1px;
    height: 1px;
    overflow: hidden;
  ...
  .charts-workbench__column--left .charts-diagnosis__table tbody {
    display: grid;
  }

  .charts-workbench__column--left .charts-diagnosis__row {
    display: grid;
    grid-template-columns: minmax(0, 1fr) auto auto auto auto;
    grid-template-areas: "name date attrs actions outcome";
    column-gap: var(--charts-space-xs);
    row-gap: 0;
    align-items: center;
    min-height: 2.85rem;
  ...
  .charts-workbench__column--left .charts-diagnosis__table tbody tr:last-child {
    border-bottom: 0;
  }

  .charts-workbench__column--left .charts-diagnosis__table th,
  .charts-workbench__column--left .charts-diagnosis__table td {
    display: flex;
    align-items: center;
    border-bottom: 0;
    padding: 0;
  ...
  .charts-workbench__column--left .charts-diagnosis__cell--name {
    grid-area: name;
    width: auto;
    min-width: 0;
    overflow: hidden;
  ...
  .charts-workbench__column--left .charts-diagnosis__cell--name .charts-diagnosis__name {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
  }

  .charts-workbench__column--left .charts-diagnosis__cell--name .charts-diagnosis__subvalue {
    display: none;
  }

  .charts-workbench__column--left .charts-diagnosis__cell--attrs {
    grid-area: attrs;
    width: auto;
  }

  .charts-workbench__column--left .charts-diagnosis__cell--date {
    grid-area: date;
    width: auto;
    color: #64748b;
    white-space: nowrap;
  ...
  .charts-workbench__column--left .charts-diagnosis__cell--code {
    display: none;
  }

  .charts-workbench__column--left .charts-diagnosis__cell--outcome {
    grid-area: outcome;
    display: flex;
    justify-content: flex-end;
    width: auto;
  ...
  .charts-workbench__column--left .charts-diagnosis__cell--actions {
    grid-area: actions;
    width: auto;
    align-self: center;
  }

  .charts-workbench__column--left .charts-diagnosis__item-actions {
    display: grid;
    grid-template-columns: repeat(2, 2rem);
    gap: 3px;
  }

  .charts-workbench__column--left .charts-side-panel__item-actions.charts-diagnosis__item-actions .charts-diagnosis__action-button {
    width: 1.8rem;
    height: 1.8rem;
    min-width: 1.8rem;
  }

  .charts-workbench__column--left .charts-diagnosis__action-icon {
    width: 1rem;
    height: 1rem;
  }
  ...
  .charts-diagnosis__quick-summary {
    cursor: pointer;
    display: flex;
    gap: var(--charts-space-xs);
    align-items: center;
    padding: 0.42rem var(--charts-space-sm);
    color: #1d4ed8;
    font-size: 0.78rem;
    font-weight: 800;
  }

  .charts-diagnosis__quick-summary::-webkit-details-marker {
    display: none;
  }

  .charts-diagnosis__quick-summary::before {
    content: '+';
    display: inline-grid;
    place-items: center;
    width: 1rem;
  ...
  .charts-diagnosis__quick-add--authoring[open] .charts-diagnosis__quick-summary::before {
    content: '-';
  }

  .charts-diagnosis__quick-summary .charts-side-panel__help {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
    font-size: 0.7rem;
  ...
  .charts-workbench__column--left .charts-diagnosis__quick-summary .charts-side-panel__help {
    display: none;
  }

  .charts-diagnosis__quick-body {
    display: grid;
    gap: var(--charts-space-xs);
    padding: 0 var(--charts-space-sm) var(--charts-space-sm);
  }
  ...
  .charts-actions--embedded .charts-actions__button[aria-disabled='true'][data-disabled-reason='locked']:not(:disabled) {
    border-color: rgba(245, 158, 11, 0.45);
    background: #fff7ed;
    color: #9a3412;
  ...
  .soap-note__print-export-action {
    display: inline-flex;
    align-items: center;
    gap: var(--charts-space-xs);
  }

  .soap-note__print-export-action .clinical-icon {
    width: 18px;
    height: 18px;
    flex: 0 0 auto;
  }
  ...
  @media (min-width: 1024px) {
    .soap-note[data-right-drawer-open='1'][data-right-drawer-mode='dock'] .soap-note__workspace,
    .soap-note[data-right-drawer-open='true'][data-right-drawer-mode='dock'] .soap-note__workspace {
  ...
  .soap-note__right-dock-group:last-child {
    border-bottom: 0;
    padding-bottom: 0;
  }
  ...
  .soap-note__right-dock-button--utility[data-utility-kind='stamp']:not([data-active='true']) {
    border-color: rgba(13, 148, 136, 0.3);
    background: #f0fdfa;
  }

  .soap-note__right-dock-button--utility[data-utility-kind='document']:not([data-active='true']) {
    border-color: rgba(217, 119, 6, 0.32);
    background: #fffbeb;
  }

  .soap-note__right-dock-button--utility[data-utility-kind='imaging']:not([data-active='true']) {
    border-color: rgba(14, 116, 144, 0.3);
    background: #ecfeff;
  }

  .soap-note__right-dock-button--utility:disabled {
    opacity: 0.55;
    cursor: not-allowed;
    box-shadow: none;
  }
  ...
  .soap-note__right-dock-utility-icon {
    min-width: 1.7rem;
    min-height: 1.7rem;
    border-radius: 999px;
    display: inline-flex;
  ...
  .soap-note__right-dock-area {
    ...
    align-self: start;
    position: absolute;
    top: calc(5.2rem + var(--charts-space-md));
    right: var(--charts-space-sm);
    min-width: 72px;
    min-height: 0;
    max-height: calc(100vh - (var(--charts-space-sm) * 2));
    overflow: hidden;
  ...
  .soap-note__right-drawer-source-overview {
    min-width: 0;
    min-height: 0;
    display: flex;
    flex-direction: column;
  ...
  .soap-note__order-workspace {
    align-self: start;
    gap: var(--charts-space-xs);
  }

  .soap-note__paper[data-right-pane-mode='edit'] {
    border-color: rgba(37, 99, 235, 0.28);
  }
  ...
  .order-dock__workbench {
    display: grid;
    grid-template-columns: minmax(6.6rem, 0.72fr) minmax(0, 1.8fr);
    gap: 0.34rem;
    border: 1px solid rgba(148, 163, 184, 0.32);
    border-radius: var(--charts-radius-md);
    background: #ffffff;
  ...
  .order-dock__workbench-rail {
    display: grid;
    gap: 4px;
    align-content: start;
  }

  .order-dock__workbench-category {
    display: grid;
    grid-template-columns: minmax(0, 1fr) auto;
    align-items: center;
    gap: 0.4rem;
  ...
  .order-dock__workbench-category[data-active='true'] {
    border-color: rgba(37, 99, 235, 0.5);
    background: #eff6ff;
    color: #1d4ed8;
  }

  .order-dock__workbench-category span {
    font-size: 0.78rem;
    font-weight: 800;
    overflow-wrap: anywhere;
  }

  .order-dock__workbench-category strong {
    min-width: 1.65rem;
    border-radius: 999px;
  ...
  .order-dock__workbench-stage {
    display: grid;
    grid-template-columns: minmax(0, 1.55fr) minmax(11rem, 0.8fr);
    gap: 0.34rem;
    align-items: stretch;
  }

  .order-dock__workbench-pane {
    display: grid;
    align-content: start;
    gap: 0.3rem;
    border: 1px solid rgba(148, 163, 184, 0.24);
  ...
  .order-dock__workbench-pane-header {
    display: flex;
    align-items: center;
    justify-content: space-between;
    gap: 0.4rem;
  ...
  .order-dock__workbench-pane strong {
    font-size: 0.78rem;
    color: #0f172a;
  }

  .order-dock__workbench-pane span {
    font-size: 0.72rem;
    color: #475569;
    line-height: 1.25;
  }

  .order-dock__workbench-chip {
    border-radius: 999px;
  ...
  .order-dock__workbench-content-line {
    display: flex;
    flex-wrap: wrap;
    align-items: center;
    gap: 0.25rem;
  ...
  .order-dock__workbench-content-line span,
  .order-dock__workbench-content-line strong {
    border-radius: 999px;
  ...
  .order-dock__bundle-action--primary {
    border-color: rgba(37, 99, 235, 0.5);
    background: #eff6ff;
    color: #1d4ed8;
  }
  ...
  .soap-note__order-category-strip {
    display: grid;
  ...
  .soap-note__order-category-chip {
    min-width: 0;
    min-height: 38px;
  ...
  .soap-note__order-category-chip[data-active='true'] {
  ...
  .soap-note__order-category-chip[data-empty='true'] {
    border-style: dashed;
    color: #475569;
  }

  .soap-note__order-category-count {
    min-width: 1.3rem;
    border-radius: 999px;
  ...
  .soap-note__inline-order-editor {
    display: flex;
    flex-direction: column;
    gap: var(--charts-space-xs);
    min-width: 0;
  ...
  .soap-note__inline-order-editor .charts-side-panel__section {
    gap: var(--charts-space-xs);
  }

  .soap-note__inline-order-editor .charts-side-panel__section-header {
    padding: 0.45rem 0.55rem;
    border-radius: var(--charts-radius-sm);
  }

  .soap-note__inline-order-editor .charts-side-panel__subheader-actions,
  .soap-note__inline-order-editor .charts-side-panel__actions--footer {
    display: flex;
    flex-wrap: wrap;
    gap: 0.35rem;
  }

  .soap-note__inline-order-editor .charts-side-panel__ghost,
  .soap-note__inline-order-editor .charts-side-panel__row-delete,
  .soap-note__inline-order-editor .charts-side-panel__action {
    min-height: 34px;
    padding: 0.34rem 0.52rem;
    font-size: 0.78rem;
  }

  .soap-note__inline-order-editor .charts-side-panel__dock-body {
    gap: var(--charts-space-xs);
    padding-bottom: calc(var(--charts-space-lg) + 5rem);
  }

  .soap-note__inline-order-editor .charts-side-panel__notice,
  .soap-note__inline-order-editor .charts-side-panel__help,
  .soap-note__inline-order-editor .charts-side-panel__message {
    font-size: 0.78rem;
  }

  .soap-note__inline-order-editor .charts-order-editor__manual-card,
  .soap-note__inline-order-editor .charts-order-editor__secondary-section {
    padding: 0.55rem;
    border-radius: var(--charts-radius-sm);
  }

  .soap-note__order-empty-inline {
  ...
  .soap-note__summary-card--add {
    color: #1d4ed8;
  }

  .soap-note__summary-card--add[aria-disabled='true'] {
    color: #64748b;
    cursor: not-allowed;
    background: #f8fafc;
  }

  .soap-note__summary-add-label {
    font-weight: 800;
    color: inherit;
  }
  ...
  @media (max-width: 1280px) {
    ...
    .charts-workbench__body {
      grid-template-columns: minmax(160px, 0.34fr) minmax(0, 1fr) minmax(300px, 0.72fr);
    }
