...
function ChartsContent({ onRequestHardReload }: { onRequestHardReload: () => void }) {
  ...
  const sendConfirmSummary = useMemo(
    () => ({
      ...
      insuranceCombination: encounterContext.insuranceCombinationNumber ?? selectedEntry?.insuranceCombinationNumber ?? patientDisplay.insurance,
    ...
    [
      ...
      patientDisplay.department,
      patientDisplay.insurance,
      patientDisplay.name,
      patientDisplay.physician,
      patientDisplay.sex,
      patientId,
      receptionId,
