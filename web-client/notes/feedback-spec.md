...
- `DiagnosisEditPanel` の disease conflict/sync/manual-resolution note は canonical copy を使い、candidate や mirror の raw payload を通常面へ露出しません。manual-resolution は対象病名がある時だけ表示します。
