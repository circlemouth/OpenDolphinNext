...
`web-client/notes/` は web-client current contract の正本です。README 本体には要約だけを残し、機能別 contract はここへ集約します。
...
- [radiology-order-canonical-contract-20260404.md](radiology-order-canonical-contract-20260404.md)

## Release Boundary
- [release-gate.md](release-gate.md)
- current validation の実行正本は [../../docs/runbooks/release-validation.md](../../docs/runbooks/release-validation.md)
